...
namespace TehGM.Wolfringo.Utilities
{
    ...
    /// <remarks>This service provider is used automatically by Commands Service when no own <see cref="IServiceProvider"/> is provided via constructor injection.</remarks>
