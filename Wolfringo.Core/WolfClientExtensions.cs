...
{
    /// <summary>Extension methods for <see cref="IWolfClient"/>.</summary>
    public static class WolfClientExtensions
    {
        ...
        /// <param name="client">Client to listen to events of.</param>
        ...
        /// <param name="client">Client to remove events listener from.</param>
