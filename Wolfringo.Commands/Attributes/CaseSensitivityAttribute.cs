...
namespace TehGM.Wolfringo.Commands
{
    ...
    /// <para>Respecting case sensitivity depends on the command initializer. All command initializers included with Wolfringo respect command's case sensitivity - respecting both <see cref="CaseSensitivityAttribute"/> and value in <see cref="ICommandsOptions"/>.</para></remarks>
